...
var now_level = 0
#var room_size = [100, 100, 2500, 1300]
var room_size = [100, 100, 300, 300]

var list_of_looped_anims = ["walk", "fly", "stay", "fire", "spawn"]

# heavy, normal, light, healer, mage
# var normal_waves = [[0, 3, 0, 0, 0], [0, 2, 2, 0, 0], [0, 3, 0, 0, 1], [1, 2, 0, 0, 0]]
var normal_waves = [[0, 1, 0, 1, 1]]
...
var healer_enemy_preset = [6, 100, 2, 1000, 1, 2, 3.6, 6]
...
var healer_enemy_anim_pos = [["walk", 0, 1, 100], ["heal", 2, 5, 200]]
var mage_enemy_anim_pos = [["walk", 0, 1, 160], ["attack", 2, 6, 100], ["dead", 7, 10, 140]]

# animation's name, start frame, end frame, animation step delt
var spawn_enemy = [["spawn", 0, 2, 100]]
...
var bullet_anim_pos = [["prepare", 0, 0, 0], ["fly", 0, 2, 60], ["hit", 3, 4, 40]]
var fireball_anim_pos = [["prepare", 0, 3, 25], ["fly", 4, 6, 60], ["hit", 7, 12, 20]]

						#///////EFFECTS\\\\\\\#

#heal hp, frames count, scale
var heal_effect_preset = [2, 2, 2]

# animation's name, start frame, end frame, animation step delt
var heal_anim_pos = [["heal", 0, 1, 100]]
